...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            experts::expert_run_factory_plan_decide,
            experts::expert_run_factory_final_decide,
            experts::expert_run_factory_cancel,
            experts::expert_run_factory_release_claim,
            experts::expert_run_factory_waive_review,
            experts::expert_run_factory_resolve_blocker,
            ...
            install::agent_rosters_reconcile,
            install::agent_roster_plan,
            install::agent_roster_apply,
            install::agent_roster_disable,
            install::agent_roster_enable,
            install::agent_roster_version_history,
            install::agent_roster_version_rollback,
